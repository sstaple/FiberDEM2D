...
namespace PlotFDEM.MatrixContinuum
{
    ...
    public class MatrixContinuumRigidFiberModel: iMatrixModel
    {
        ...
        public double[] CalculateStress(double x, double y, double z, double[] q, int iteration, double yLeft, double yRight, bool bPlotMatrixResultsOnly = false)
        {
        ...
        public double CalculateDamage(double x, double y, double z, double[] q, int iteration, double yLeft, double yRight, bool bPlotMatrixResultsOnly = false)
        {
            return 0;
        }
        #endregion
