Color.FromArgb( 174 ,   198 ,   55  )   ,   Color.FromArgb( 184 ,   196 ,   49  )   ,   Color.FromArgb( 194 ,   195 ,   44  )   ,   Color.FromArgb( 200 ,   193 ,   41  )   ,   Color.FromArgb( 208 ,   191 ,   39  )   ,
Color.FromArgb( 214 ,   190 ,   39  )   ,   Color.FromArgb( 225 ,   188 ,   42  )   ,   Color.FromArgb( 230 ,   187 ,   45  )   ,   Color.FromArgb( 236 ,   186 ,   50  )   ,   Color.FromArgb( 239 ,   186 ,   53  )   ,
Color.FromArgb( 245 ,   186 ,   59  )   ,   Color.FromArgb( 247 ,   186 ,   61  )   ,   Color.FromArgb( 251 ,   187 ,   62  )   ,   Color.FromArgb( 252 ,   188 ,   62  )   ,   Color.FromArgb( 254 ,   190 ,   60  )   ,
Color.FromArgb( 254 ,   193 ,   58  )   ,   Color.FromArgb( 254 ,   200 ,   52  )   ,   Color.FromArgb( 253 ,   205 ,   49  )   ,   Color.FromArgb( 251 ,   211 ,   46  )   ,   Color.FromArgb( 246 ,   222 ,   41  )   ,
Color.FromArgb( 245 ,   229 ,   38  )   ,   Color.FromArgb( 245 ,   232 ,   37  )   ,   Color.FromArgb( 245 ,   238 ,   33  )   ,   Color.FromArgb( 246 ,   242 ,   30  )   ,   Color.FromArgb( 249 ,   251 ,   21  )
            });
            lColorSchemeNames.Add("Parula(Matlab)");
        ...
        protected void UpdateAll()
        {
            ...
            if (!cbAutomaticRange.Checked)  //I think this should be changed....
            {
        ...
        private void bQueryPoint_Click(object sender, EventArgs e)
        {
            ...
            if (rbField.Checked)
            {
                int nLS = (int)nudLS.Value;
                PlotFieldAtATime(nMatrix, xLoc, nY, nLS);

            }
            else
            {
                PlotHistoryOfPoint(nMatrix, xLoc, nZ, nY);
            }
        }
        private void PlotFieldAtATime(int nMatrix, double xLoc, int nY, int nLStep)
        {
            int nPoints = 100;
            string sLocation, sTitle, xAxis;
            //make arrays for x and y:
            double[] xValue = new double[nPoints];
            double[] Result = new double[nPoints];

            double zBot = myPlot.lMatrix[nMatrix].lz[0][3];
            double zTop = myPlot.lMatrix[nMatrix].lz[0][0];
            ...
            SinglePlotForm myPointQueryPlot = new SinglePlotForm(sTitle, xAxis, (cbPlotType.Text + " " + cbPlotComponent.Text),
                sLocation, xValue, Result);

            myPointQueryPlot.Plot();
        }

        private void PlotHistoryOfPoint(int nMatrix, double xLoc, int nZ, int nY)
        {
            ...
            SinglePlotForm myPointQueryPlot = new SinglePlotForm(sTitle, "LoadStep", (cbPlotType.Text + " " + cbPlotComponent.Text),
        ...
        private void rbField_CheckedChanged(object sender, EventArgs e)
        {
            if (rbField.Checked)
            {
                cbZPointQuery.Visible = false;
                nudZ.Visible = true;
                gbAll.Visible = true;
                rbAllY.Checked = true;
                lLS.Visible = true;
                nudLS.Visible = true;
                nudLS.Maximum = myPlot.lMatrix[0].lIteration.Count;
            }
            else
            {
                cbZPointQuery.Visible = true;
                nudZ.Visible = false;
                gbAll.Visible = false;
                lLS.Visible = false;
                nudLS.Visible = true;
        ...
        private void rbAllY_CheckedChanged(object sender, EventArgs e)
        {
            if (rbAllY.Checked)
            {
                cbYPointQuery.Enabled = false;
                nudZ.Enabled = true;
            }
            else
            {
                cbYPointQuery.Enabled = true;
                nudZ.Enabled = false;
            }
        }
        #endregion
