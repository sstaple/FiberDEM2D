...
namespace PlotFDEM.MatrixContinuum
{
    ...
    public class MatrixContinuumElasticFiberModel : iMatrixModel
    {
        ...
        public double[] CalculateDisplacement(double x, double y, double z, double[] q, int iteration, double yLeft, double yRight, bool bPlotMatrixResultsOnly=false)
        {
            double rmz = r * r - z * z;
        ...
        public double[] CalculateStrain(double x, double y, double z, double[] q, int iteration, double yLeft, double yRight, bool bPlotMatrixResultsOnly = false)
        {
            double z2 = z * z;
            double r2 = r * r;
            double d2 = d * d;
        ...
        public virtual double[] CalculateStress(double x, double y, double z, double[] q, int iteration, double yLeft, double yRight, bool bPlotMatrixResultsOnly = false)
        {
            double[] strain = this.CalculateStrain(x, y, z, q, iteration, yLeft, yRight);

            return MatrixMath.Multiply(D, strain);
        }
        public virtual double CalculateDamage(double x, double y, double z, double[] q, int iteration, double yLeft, double yRight, bool bPlotMatrixResultsOnly = false)
        {
            return 0;
        }
