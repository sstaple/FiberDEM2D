    ...
    public class MatrixContinuumElasticFiberDamageModel : MatrixContinuumElasticFiberModel
    {
...

        {
            ...
            if (!setZValues)
            {
                ...
                zPoints = VectorMath.Stack(zPtsBot, zPtsTop);

            }
        }
        public override double[] CalculateStress(double x, double y, double z, double[] q, int iteration, double yLeft, double yRight, bool bPlotMatrixResultsOnly = false)
        {
            double[] strain = this.CalculateStrain(x, y, z, q, iteration,  yLeft,  yRight, bPlotMatrixResultsOnly);

            double damage_i = CalculateDamage( x,  y,  z,  q,  iteration,  yLeft,  yRight, bPlotMatrixResultsOnly);
        ...
        public override double CalculateDamage(double x, double y, double z, double[] q, int iteration, double yLeft, double yRight, bool bPlotMatrixResultsOnly = false)
        {
