...
        double KnOverKt = 4.0/3.0;
		...
		[Test]
		public void Test_1_F1_bottomLeft_v0_F2_bottomRight_v10_F3_TopLeft_v0_F4_TopRight_v10()
		{
			//8/20/2021: doesn't Pass
			ShearFourFiberTest(new double [3]{0,0,0}, new double [3]{0,1.9,0}, new double [3]{0,0,1.9}, new double [3]{0,1.9,1.9}, new double [3]{0,0,0}, new double [3]{0,0,10}, new double [3]{0,0,0}, new double [3]{0,0,10});
			 ...
			 Assert.That(ccC.HomogenizedStress[n][1,2], Is.EqualTo(0.0045467).Within(0.0000001));
			 Assert.That(ccC.HomogenizedStress[n][2,0], Is.EqualTo(0).Within(0));
			 Assert.That(ccC.HomogenizedStress[n][2,1], Is.EqualTo(0.0045467).Within(0.0000001));
			 Assert.That(ccC.HomogenizedStress[n][2,2], Is.EqualTo(-0.9327).Within(0.0001));
			
		}
		[Test]
		public void Test_2_F1_bottomLeft_v0_F2_bottomRight_vm10_F3_TopLeft_v0_F4_TopRight_vm10()
		{
			//8/20/2021: doesn't Pass
			ShearFourFiberTest(new double [3]{0,0,0}, new double [3]{0,1.9,0}, new double [3]{0,0,1.9}, new double [3]{0,1.9,1.9}, new double [3]{0,0,0}, new double [3]{0,0,-10}, new double [3]{0,0,0}, new double [3]{0,0,-10});
		...
		[Test]
		public void Test_3_F1_bottomLeft_v10_F2_bottomRight_v0_F3_TopLeft_v10_F4_TopRight_v0()
		{
			//8/20/2021: doesn't Pass
			ShearFourFiberTest(new double [3]{0,0,0}, new double [3]{0,1.9,0}, new double [3]{0,0,1.9}, new double [3]{0,1.9,1.9}, new double [3]{0,0,10}, new double [3]{0,0,0}, new double [3]{0,0,10}, new double [3]{0,0,0});
		...
		[Test]
		public void Test_4_F1_bottomLeft_v10_F2_bottomRight_v0_F3_TopLeft_v10_F4_TopRight_v0()
		{
			//8/20/2021: doesn't Pass
			ShearFourFiberTest(new double [3]{0,0,0}, new double [3]{0,1.9,0}, new double [3]{0,0,1.9}, new double [3]{0,1.9,1.9}, new double [3]{0,0,-10}, new double [3]{0,0,0}, new double [3]{0,0,-10}, new double [3]{0,0,0});
